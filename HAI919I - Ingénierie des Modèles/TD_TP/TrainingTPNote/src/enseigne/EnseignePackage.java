...
public interface EnseignePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GAMME_PERSONNALISABLE__OBJET = 0;
	 ...
	 * @ordered
	 */
	int GAMME_PERSONNALISABLE__ELEMENTDEPERSONNALISATION = 1;
	 ...
	 * @ordered
	 */
	int GAMME_PERSONNALISABLE__CARACTERISTIQUEVARIABLE = 2;
	...
	/**
	 * The meta object id for the '{@link enseigne.impl.ObjetImpl <em>Objet</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see enseigne.impl.ObjetImpl
	 * @see enseigne.impl.EnseignePackageImpl#getObjet()
	 * @generated
	 */
	int OBJET = 1;
	 ...
	 * @generated
	 */
	int ELEMENT_DE_PERSONNALISATION = 3;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link enseigne.GammePersonnalisable#getObjet <em>Objet</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Objet</em>'.
	 * @see enseigne.GammePersonnalisable#getObjet()
	 * @see #getGammePersonnalisable()
	 * @generated
	 */
	EReference getGammePersonnalisable_Objet();
	...
	/**
	 * Returns the meta object for class '{@link enseigne.Objet <em>Objet</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference GAMME_PERSONNALISABLE__OBJET = eINSTANCE.getGammePersonnalisable_Objet();
		...
		/**
		 * The meta object literal for the '{@link enseigne.impl.ObjetImpl <em>Objet</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see enseigne.impl.ObjetImpl
		 * @see enseigne.impl.EnseignePackageImpl#getObjet()
